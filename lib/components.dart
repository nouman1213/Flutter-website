...
urlLauncher(String imgPath, String url, {Color? color}) {
  return IconButton(
    icon: SvgPicture.asset(imgPath, color: color, width: 35),
    onPressed: () async {
    ...
    return Drawer(
      ...
      child: Column(
        ...
        children: [
          ...
          SansBold("Nouman Ashraf", 30.0),
          SizedBox(height: 15.0),
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceEvenly,
            children: [
              urlLauncher("assets/instagram.svg",
                  "https://www.instagram.com/nouman_ch1213/",
                  color: Color.fromARGB(255, 156, 53, 45)),
              urlLauncher("assets/linkedin.svg",
                  "https://www.linkedin.com/in/nouman-ashraf/"),
              urlLauncher(
                  "assets/github.svg", "https://www.github.com/nouman1213"),
            ],
          ),
        ],
      ),
